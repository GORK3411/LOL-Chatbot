...
- abilities:
  ...
  - decide if rag would be a good solution to find for an ability's specific effect like if the ability has a specific CC effect or not (the rag would be used only if the user is asking about abilities in a whole, not for a specific champion's ability)
